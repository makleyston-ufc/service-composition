...
if __name__ == "__main__":
    ...
    config = ServiceConfig(
        ...
        service_urn=os.getenv("SERVICE_URN", "urn:ufcity:service:alternative-regional-pressure"),
        input_topics=_parse_topics(sub_topics_env, DEFAULT_INPUT_TOPICS),
        output_topic=os.getenv("MQTT_PUB_TOPIC", DEFAULT_OUTPUT_TOPIC),
        semantic_property_kind=os.getenv("SEMANTIC_PROPERTY_KIND", "urn:ufcity:propertykind:AlternativeRegionalPressure"),
