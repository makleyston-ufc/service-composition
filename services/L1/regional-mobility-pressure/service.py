...
SERVICE_NAME = "regional-mobility-pressure"
DEFAULT_INPUT_TOPICS = [
    "service/mobility/inference/traffic-flow",
    "service/mobility/inference/bus-regional-supply",
]
DEFAULT_OUTPUT_TOPIC = "service/mobility/inference/regional-mobility-pressure"
DEFAULT_SERVICE_URN = "urn:ufcity:service:regional-mobility-pressure"
DEFAULT_PROPERTY_KIND = "urn:ufcity:propertykind:RegionalMobilityPressure"
...
class RegionalMobilityPressureService(Observer):
    def __init__(
        self,
        *,
...
def main() -> None:
    ...
    observer = RegionalMobilityPressureService(
